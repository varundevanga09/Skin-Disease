...
model_path2 = 'model1.h5' # load .h5 Model
...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "DERMATOFIBROMA","after.html"
    elif result == 1:
        return "MELANOMA","after.html"
    elif result == 2:
        return "PIGMENTED BENIGN KERATOSIS","after.html"
    elif result == 3:
        return "SEBORRHEIC KERATOSIS","after.html"
    elif result == 4:
        return "SQUAMOUS CELL CARCINOMA","after.html"
    elif result == 5:
        return "VASCULAR LESION","after.html"
